              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: populars[index].viewIsSelected ? Colors.white : Colors.transparent,
                    borderRadius: BorderRadius.circular(16),
                    boxShadow: [
                      BoxShadow(
                        color: populars[index].viewIsSelected ? Color(0xFF1D1617).withOpacity(0.07) : Colors.transparent,
                        offset: Offset(0, 10),
                        blurRadius: 40,
                        spreadRadius: 0.0,
                      ),
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    decoration: BoxDecoration(
                      gradient:
                          diets[index].backgroundColor.withOpacity(0.8),
                      borderRadius: BorderRadius.circular(16),
                    ),
                    width: 210,
                    child: Column(
